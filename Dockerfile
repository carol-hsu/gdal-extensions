...
RUN wget http://download.osgeo.org/proj/proj-6.1.0.tar.gz && \
...
RUN tar xvf proj-6.1.0.tar.gz && \
    tar xvf FileGDB_API_1_5_1-64gcc51.tar.gz && \
...
## setup FileGDB
RUN cp $DEFAULT_DIR/FileGDB_API-64gcc51/lib/* /usr/local/lib
